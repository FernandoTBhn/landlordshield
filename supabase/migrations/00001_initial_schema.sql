-- LandlordShield — Initial Schema
-- Tables: properties, tenants, information_sheet_records, certificates
...
-- =============================================================
-- INFORMATION SHEET RECORDS (Prescribed Information / S.213 HA 2004)
-- =============================================================
...
-- =============================================================
-- CERTIFICATES (Gas Safety, EPC, EICR, etc.)
-- =============================================================
create table public.certificates (
  ...
  constraint certificates_cert_type_check check (
    cert_type in ('gas_safety', 'epc', 'eicr', 'pat', 'legionella', 'fire_safety', 'other')
  ),
